        ...
        <div class="col-12">
          <div class="card card-dark" style="margin-top: 1rem">
            <div class="card-header">
              <h3 class="card-title">Hasil Final Pertandingan</h3>
            </div>
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="pemenang" ></select>
                  </div>
                </div>
              </div>
  ...
  var id_data;
    ...
    function REFRESH_DATA(){
      ...
      var tb_data = $("#tb_data").DataTable({
        ...
        "responsive": true,
        "ajax": {
            "url": "<?php echo site_url('jadwal/getHasilFinal') ?>",
            "type": "POST",
            "data": {
    ...
    $("#BTN_SAVE").click(function(){
      ...
      urlPost = "<?php echo site_url('jadwal/updateHasilPertandingan') ?>";
